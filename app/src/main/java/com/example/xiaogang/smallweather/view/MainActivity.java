...
//              weather.aqi = weatherBean.mHeWeather.get(0).aqi;   有的城市没有这一项数据返回
                ...
                SharedPrefUtils.getInstance().putString(AppConstant.SharedPreferenceKey.NOW_WEATHER, weather.now.tmp);
        ...
        Object city = SharedPreferenceUtil.getData(MainActivity.this, "city", "北京");
